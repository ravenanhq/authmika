...
const DeleteModal: React.FC<DeleteModalProps> = ({ open, onClose, onDeleteConfirm, tableRowName }) => {
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      <div>
        ...
        <p>Are you sure you want to delete this item? <span style={{color:"#191c1a"}}>{DeleteName}</span></p>
